...
|Mental confusion|Isoniazid, Rifampicin and Pyrazinamide|1. If jaundiced, suspect liver failure, stop drugs (see below)<br>2. If no jaundice, suspect Isoniazid, increase dose of pyridoxine<br>|

|Side-Effects|Drug(S) Likely To Cause|Management|
|---|---|---|
|Visual impairment (other causes<br><br>excluded)|Ethambutol|Stop Ethambutol. Use streptomycin|
...
|TREATMENT|LOC|
|---|---|
| Stop all drugs immediately  Manage supportively  When jaundice has resolved, re-introduce single drugs at<br><br>3-7 days interval, starting from the least likely involved|H RR|

Adjunctive treatment

|TREATMENT|LOC|
|---|---|
| If reaction very severe, do not try to restart pyrazinamide. If RH tolerated, do not try pyrazinamide<br><br> Use alternative regimen avoiding the causative drug|H RR|
