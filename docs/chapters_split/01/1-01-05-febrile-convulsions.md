...
| If unconscious: position the patient on the side (recovery position) and ensure airways, breathing and circulation (ABC) | |
| If persistent convulsions: see section 9.1.1 | HC4 |
