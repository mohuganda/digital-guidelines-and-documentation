...
Most common form of chronic inflammatory joint disease affecting mainly
women. Attacks tend to be bilateral with symmetrical involvement that
...
Fingers are most affected (metacarpophalangeal, or proximal interpahalangeal), but all small and medium size joints
can be affected (rarely hips and spine)

Extra articular manifestations: mild fever, weakness, lethargy, anorexia, weight loss, rheumatoid nodules (20%) at
extensor surface like forearm below joint
...
Symptomatic treatment can be started at lower level but appropriate
management requires referral for specialist care.
TREATMENT
...
- They slow disease progression, but should not
