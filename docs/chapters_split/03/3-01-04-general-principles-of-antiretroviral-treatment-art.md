...
- History of opportunistic infections and other significant ill-

nesses e.g. TB and STIs, hospitalisations, and surgeries

- Current medications (including anti-TB drugs, traditional

therapies, etc.) Physical exam
...
- Inhibit viral replication as reflected in plasma HIV concen-
...
- Maximisation of adherence to ART: adequate support to pa-
...
- Use of viral load estimates for monitoring Principles of ART
...
- Medicine interactions and resistance may decrease the po-
...
- Children are dependent on adults for adherence to ART Available Medicines for ART
...
|CLASS|EXAMPLES|
|---|---|
|Nucleoside reverse transcriptase inhibitors (NtRTIs) incorporate themselves into the DNA of the virus, thereby stopping the building process|Tenofovir (TDF) Zidovudine (AZT) Lamivudine (3TC)<br><br>Abacavir (ABC|
|Non-nucleoside reverse transcriptase inhibitors (NNRTIs) stop HIV production by binding directly onto the reverse<br><br>transcriptase enzyme, and prevent the conversion of RNA to DNA|Efavirenz (EFV) Nevirapine (NVP) Etravirine (ETV)|
...
- ARV doses need to be adjusted from time to time as the chil-

dren grow quickly and thus, their weight changes.
